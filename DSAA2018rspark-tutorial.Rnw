...
\vspace{0.5 cm}
\textbf{Technically, you do not need to download R and RStudio to your laptop. Both of these systems will actually be run in Docker containers as described in the next several slides.}
\end{frame}

\begin{frame}[containsverbatim]
  \frametitle{Version Contral Using Git}
...
\vspace{0.5 cm}
If you use Windows, I recommed you install another version.Go to:
...
The tutorial slides provide an overview of the tutorial content. The GitHub repo for the slides can be found here: \href{https://github.com/jharner/DSAA2018rspark-tutorial}{https://github.com/jharner/DSAA2018rspark-tutorial}\\
\vspace{0.5 cm}
...
This \texttt{rspark-tutorial} local repo can then be imported into the computional environment used in this tutorial, which is called \href{https://github.com/jharner/rspark}{rspark}. This is the development environment.\\
\vspace{0.5 cm}
...
In order to execute the content in the \texttt{rspark-tutorial}, the \texttt{rspark} computational environment must be run as a web applicaton. Follow the directions in the \href{https://github.com/jharner/rspark-docker}{rspark-docker} to launch \texttt{rspark}.\\
\vspace{0.25 cm}
...
In order to execute the content in the \texttt{rspark-tutorial}, the \texttt{rspark} computational environment must be run as a web applicaton. Follow the directions in the \href{https://github.com/jharner/rspark-docker}{rspark-docker} to launch \texttt{rspark}.\\
\vspace{0.5 cm}
Use the UNIX command \texttt{cd} to go the directory (folder) containing \texttt{rspark-docker}. Then run the \texttt{start.sh} shell script. Do something like this from the terminal:\\
\texttt{cd rspark-docker}\\
\texttt{chmod 755 start.sh}\\
\texttt{./start.sh}\\
The second line makes the script executable if it is not already. The third line executes the script.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/blob/master/m1\_fundamentals/s4\_ml\_basics/ml\_basics.Rmd}{here}.
\end{frame}
...
\vspace{0.5 cm}
The \texttt{dplyr} package is part of the `tidyverse`. It provides a grammar of data maniputation using a set of verbs for transforming tibbles (or data frames) in R or across various backend data sources.\\
\vspace{0.5 cm}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m5_spark/s1_spark_basics}{here}.
\end{frame}
...
\vspace{0.5 cm}
Besides providing functions for manipulating data frames in R, \texttt{dplyr} forms an interface for manipulating DataFrames directly in Spark using R. The user can performs operations on Spark DataFrames such as: selecting, filtering, and aggregating; performing joins.\\
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m5_spark/s2_sparklyr_dplyr}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m5_spark/s3_sparklyr_sql}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m5_spark/s4_sparklyr_apply}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m6_supervised_learning/s1_regression_basics}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m6_supervised_learning/s2_regularization_basics}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m6_supervised_learning/s3_slump_test}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/blob/master/m6_supervised_learning/s4_logistic_regr_basics}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m6_supervised_learning/s5_wine_quality}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m6_supervised_learning/s6_tree_models}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m7_unsupervised_learning/s1_pca}{here}.
\end{frame}
...
\vspace{0.5 cm}
The notes for this section are \href{https://github.com/jharner/rspark-tutorial/tree/master/m7_unsupervised_learning/s2_kmeans}{here}.
\end{frame}
