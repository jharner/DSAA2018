...
\begin{itemize}
  \item the \href{https://github.com/jharner/DSAA2018rspark-tutorial}{DSAA 2018 rspark-tutorial} slides (these slides)
...
\end{itemize}
These components are discussed in the next group of slides.
\end{frame}
